...
public class SudoCommand : ICommand
{
    ...
    public override string GetCmdDescription() => "<b>sudo <cmd></b> : execute <cmd> as root";
    ...
    public override void OnCmdMatch()
    {
        ...
        if(args[1] == "-l") {
            ...
            var output = "Matching Defaults entries for \""+ user +"\" on " + host + ":\n"+
                         ...
                         "User \""+ TerminalHandler.Instance.TerminalConfig.CurrentUser + "\" may run the following commands on challenge02:\n"+
